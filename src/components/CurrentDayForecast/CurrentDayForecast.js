...
export default function CurrentDayForecast({ weekday, date, location, temperature, weatherIcon, weatherDescription,currentDayDetails,AllowDetailedView }) {
 ...
 <>
      ...
      {!AllowDetailedView&&  <div className="d-flex">
        ...
        {AllowDetailedView&&
                <div className={styles.weathermain}>
                    <div className={styles.weatherdata}>
                        <div className={`${styles.weathermore} d-flex flex-column justify-content-between pt-3 pb-2 pl-2`}>
                           
                            <div>
                                <h2 className={`${styles.weatherWeekDay}  mb-1`}>{weekday}</h2>
                                <p className="mb-0">{date}</p>
